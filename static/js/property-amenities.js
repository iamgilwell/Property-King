$(document).ready(function () {
  ...
  var formSubmitBtn = document.getElementById('form-amenity-submit-btn');
  ...
  $('#form-amenity-submit-btn').click('submit', function (e) {
    e.preventDefault();
    ...
    $.ajax({
      ...
      url: BASE_ENDPOINT + 'properties/property-ammenities/',
      data: {
        name: txtName.value,
